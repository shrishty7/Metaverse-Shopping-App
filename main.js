...
class ThirdPersonCameraDemo {
  ...
  _Initialize() {
    ...
    const texture = loader.load([
        './resources/lawn/posx_1.jpg',
        './resources/lawn/negx_1.jpg',
        './resources/lawn/posy_1.jpg',
        './resources/lawn/negy_1.jpg',
        './resources/lawn/posz_1.jpg',
        './resources/lawn/negz_1.jpg',
    ]);
    texture.encoding = THREE.sRGBEncoding;
    this._scene.background = texture;

    const planeLoader = new THREE.TextureLoader().load(
        './resources/bgtiles.jpg'
    );
    planeLoader.wrapS = THREE.RepeatWrapping;
    planeLoader.wrapT = THREE.RepeatWrapping;
    planeLoader.repeat.set(4, 4);
